...
class ComsClass(object):
	...
	def serialSort(self, line):
		...
		if len(line) == 9:
			globalvars.handshakes[globalvars.componentProtocolIDs[line.split("_")[0]]] = line.split("_")[3]
			globalvars.handshakeMsgReceived[line.split("_")[2]][globalvars.componentProtocolIDs[line.split("_")[0]]] = True
