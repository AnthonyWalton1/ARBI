...
def UpdateCurrentValues():
	...
	# Note: the final enter \r\n isn't included in calculating len(line)
	[error, rtcError] = ErrorCheck(line, 1)
	


def ErrorCheck(line, updateGUI):
	...
	if len(line) == 254:
		...
		if line[156] == " " and line[159] == "_":
			print("20 correct")
			if updateGUI == 1:
				blueLed1Text.set(values[13].split("_")[1])
		else:
		...
		if line[165] == " " and line[168] == "_":
			print("21 correct")
			if updateGUI == 1:
				blueLed2Text.set(values[14].split("_")[1])
		else:
		...
		if line[174] == " " and line[177] == "_":
			print("22 correct")
			if updateGUI == 1:
				blueLed3Text.set(values[15].split("_")[1])
		else:
		...
		if line[183] == " " and line[186] == "_":
			print("23 correct")
			if updateGUI == 1:
				redLed1Text.set(values[16].split("_")[1])
		else:
		...
		if line[192] == " " and line[195] == "_":
			print("24 correct")
			if updateGUI == 1:
				redLed2Text.set(values[17].split("_")[1])
		else:
		...
		if line[201] == " " and line[204] == "_":
			print("25 correct")
			if updateGUI == 1:
				redLed3Text.set(values[18].split("_")[1])
		else:
