...
void sortInput(){
  ...
  if (inputType == "1") {
    ...
    } else if (componentID == "P102") {
      machineStates[1] = componentValueToSet.toInt();
    } else if (componentID == "P103") {
      machineStates[2] = componentValueToSet.toInt();
    }
  }

  if (inputType == "2") {
    Serial.print("2_P101_" + (String)machineStates[0] + "_P102_" + (String)machineStates[1] + "_P103_" + (String)machineStates[2] + "\r\n");
  }
